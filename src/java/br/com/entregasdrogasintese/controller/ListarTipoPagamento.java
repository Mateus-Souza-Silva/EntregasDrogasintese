...
@WebServlet(name = "ListarTipoPagamento", urlPatterns = {"/ListarTipoPagamento"})
public class ListarTipoPagamento extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            request.setAttribute("tipopagamento", dao.listar());
            request.getRequestDispatcher("DadosCobranca").forward(request, response);
        } catch (Exception ex) {
            System.out.println("Problemas ao listar TIPO PAGAMENTO CONTROLLER! Erro: " + ex.getMessage());
            ex.printStackTrace();
        }
    }
