...
@WebServlet(name = "DadosUsuario", urlPatterns = {"/DadosUsuario"})
public class DadosUsuario extends HttpServlet {
...
//            listar situacao
            ...
            request.getRequestDispatcher("Entrega/cadastrar.jsp").forward(request, response);
        } catch (Exception ex) {
            System.out.println("Problemas ao listar dados usuarios ! Erro: " + ex.getMessage());
            ex.printStackTrace();
        }
    }
