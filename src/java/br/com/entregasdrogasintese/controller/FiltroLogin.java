...
public class FiltroLogin implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        String[] excecoes = {"login.jsp", "/", "Login", "estilo.css", "logo-Drogasintese.png"};
        ...
        if (sessao.getAttribute("pessoalogada") != null) {
            liberar = true;
        }

        if (liberar) {
            //linha que libera acesso as informações
            chain.doFilter(request, response);
        }else{
            request.setAttribute("mensagem", "Acesso negado! Você precisa estar logado!");
