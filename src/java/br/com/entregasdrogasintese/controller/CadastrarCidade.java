...
public class CadastrarCidade extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        cidade.setNome(request.getParameter("nome").toUpperCase());
        ...
        try {
            ...
            if (dao.cadastrar(cidade)) {
                ...
                mensagem = "Problemas ao cadastrar Cidade! Controller!";
            }
            request.setAttribute(mensagem, "mensagem");
            request.getRequestDispatcher("Cidade/cadastrar.jsp").forward(request, response);
        } catch (Exception ex) {
            System.out.println("Problemas ao cadastrar cidade controller! Erro: " + ex.getMessage());
            ex.printStackTrace();
        }
    }
