...
@WebServlet(name = "ListarPagamento", urlPatterns = {"/ListarPagamento"})
public class ListarPagamento extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            request.setAttribute("pagamentos", dao.listar());
            ...
            System.out.println("Problemas ao listar Pagamento CONTROLLER! Erro: " + ex.getMessage());
            ex.printStackTrace();
        }
