...
@WebServlet(name = "ListarSituacao", urlPatterns = {"/ListarSituacao"})
public class ListarSituacao extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            request.setAttribute("situacao", dao.listar());
            ...
            System.out.println("Problemas ao listar Situacao CONTROLLER! Erro: " + ex.getMessage());
            ex.printStackTrace();
        }       
    }
